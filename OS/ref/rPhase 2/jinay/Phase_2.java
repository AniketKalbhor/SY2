        ...
        if(LLC>pcb.getTLL())
            ...
            try{
                ...
                if(PI == 2 || PI == 3){
                    ...
                    sb.append('\n');
                    Files.write(Paths.get("/home/aniket-u22/SY2/OS/ref/rPhase 2/jinay/out.txt"), String.valueOf(sb).getBytes(), StandardOpenOption.APPEND);
    ...
    public void terminate(int EM){
        ...
        try{
            switch (EM){
                ...
                case 0:
                    Files.write(Paths.get("/home/aniket-u22/SY2/OS/ref/rPhase 2/jinay/out.txt"), (jobDetails+interrupts+cpuDetails+"\nTerminated Sucessfully\n\n").getBytes(), StandardOpenOption.APPEND);
                    break;
                case 1:
                    Files.write(Paths.get("/home/aniket-u22/SY2/OS/ref/rPhase 2/jinay/out.txt"), (jobDetails+interrupts+cpuDetails+"\nOut of Data\n\n").getBytes(), StandardOpenOption.APPEND);
                    break;
